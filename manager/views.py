...
def dashboard(request):
    ...
    context={
        ...
        "dailyChartData":json.dumps(SummaryManger.get_daily_chart_summary(request.session.get('user'))),
        "dailyPaymentWiseData":json.dumps(SummaryManger.get_daily_chart_payment_summary(request.session.get('user')))
    }
